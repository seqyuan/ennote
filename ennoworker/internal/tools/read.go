...
func (t *ReadTool) Definition() domain.ToolDefinition {
	return domain.ToolDefinition{Name: "read", Description: "Read a UTF-8 text file inside /workspace or the read-only /skills snapshot", Parameters: schema(`{"type":"object","properties":{"path":{"type":"string"},"offset":{"type":"integer","minimum":0},"limit":{"type":"integer","minimum":1}},"required":["path"],"additionalProperties":false}`), RiskClass: domain.RiskReadOnly}
}
