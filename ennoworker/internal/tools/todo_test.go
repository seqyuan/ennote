...
func TestTodoToolStoresAndReplacesWholeList(t *testing.T) {
	...
	first := tool.Execute(context.Background(), domain.ToolCall{ID: "c1", Name: "todo",
	...
	second := tool.Execute(context.Background(), domain.ToolCall{ID: "c2", Name: "todo",
...
func TestTodoToolClearsWithEmptyList(t *testing.T) {
	...
	result := tool.Execute(context.Background(), domain.ToolCall{ID: "c", Name: "todo",
...
func TestTodoToolRejectsInvalidListWithoutMutation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := tool.Execute(context.Background(), domain.ToolCall{ID: "bad", Name: "todo",
...
func TestTodoToolRejectsNilStore(t *testing.T) {
	result := (&TodoTool{}).Execute(context.Background(), domain.ToolCall{ID: "c", Name: "todo",
